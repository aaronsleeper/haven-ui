...
| MealCard | `(agentic)` | `meal-card`, `meal-card-image`, `meal-card-placeholder`, `meal-card-content`, `meal-card-name`, `meal-card-description`, `meal-card-footer`, `meal-card-price`, `meal-card-tags` | no | Meal item: image + name + description + price + tags + action. |
...
| MenuGrid | `(agentic)` | `menu-grid`, `menu-grid-header`, `menu-grid-title`, `menu-grid-subtitle` | no | Grid container for MealCard collection. |
...
| Component | File | Classes | Preline | Notes |
|---|---|---|---|---|
| Meal Card | `patient-meal-card.html` | `meal-card`, `meal-card-img`, `meal-card-body`, `meal-card-name`, `meal-card-day`, `meal-card-tags`, `meal-card-swap`, `meal-card.is-swapped` | no | Add `.is-swapped` after swap. Missing images show `bg-sand-100` placeholder. |
