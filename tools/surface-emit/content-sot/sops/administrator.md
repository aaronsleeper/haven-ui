...
:::
::: glossary-def
The required human-subjects research training everyone must complete before working with participant data.
:::
...
:::
::: glossary-def
The study's approved rules for how the research is run, including who may see what data.
:::
...
:::
::: glossary-def
Business Associate Agreement — the contract a partner signs before they're allowed to handle participant data.
:::
...
:::
::: glossary-def
Giving each person only the system access their job needs — nothing more.
:::
...
::: attestation-gate
⏳ **Scope confirmed** — Vanessa Sena (admin task set)
:::
...
::: attestation-gate
_Awaiting scope confirmation + sign-off — draft · Version 0.1_
:::
