...
2. **Start the weekly check-in from the patient profile.** In [Care-coordinator app → Patient profile]{.screen-ref}, start a check-in and choose phone or text per the participant's saved preference. A 10–15 minute call covering order support, adherence, and any barriers to participation.
...
::: attestation-gate
_Director of Clinical Ops — signature pending_
:::
