...
- [ ] All new classes added to `packages/design-system/src/styles/tokens/components.css` with `@apply` definitions
...
- [ ] Any new dummy data schema deltas documented in `packages/design-system/src/data/_schema-notes.md`
- [ ] Any new component has a file in `packages/design-system/pattern-library/components/` with `@component-meta`
- [ ] `packages/design-system/pattern-library/COMPONENT-INDEX.md` updated if a new component was added
