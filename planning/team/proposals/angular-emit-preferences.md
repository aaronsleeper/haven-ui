...
| 16 | Angular version / zoneless API | **21.2.13** (read from `patients/package.json` 2026-05-25; stable `provideZonelessChangeDetection` + `linkedSignal` consistent) | confirmed | H | pin porter to 21.x API names | config |
